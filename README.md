...
- H2 console available at: `/h2-console` (username: username, password: password)
...
- Artemis console available at port `8161`, after the docker container is started (username: artemis, password: password)
